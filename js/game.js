...
class VicaDominoGame {
    ...
    showKeyboardPopup(keyValue, anchorEl) {
        ...
        const bigW = Math.round(keyW * 1.442);
        const bigH = Math.round(keyH * 1.442);
        ...
        svg += `<text x="${bigX + bigW/2}" y="${bigY + bigH/2 + 10}" text-anchor="middle" font-size="46" font-weight="bold" fill="#333" font-family="monospace">${keyValue}</text>`;
